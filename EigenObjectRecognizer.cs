...
namespace Emgu.CV
{
   ...
   public class EigenObjectRecognizer
   {
      ...
      /// </param>
      /// <param name="termCrit">The criteria for recognizer training</param>
      public void EigenObjectRecognizerAdd(Image<Gray, Byte>[] images, String[] labels, double eigenDistanceThreshold, ref MCvTermCriteria termCrit)
      {
      ...
      /// <summary>
      ///Вычислить собственные изображения для конкретного учебного изображения
      /// </summary>
      ...
      public static void CalcEigenObjects(Image<Gray, Byte>[] trainingImages, ref MCvTermCriteria termCrit, out Image<Gray, Single>[] eigenImages, out Image<Gray, Single> avg)
      {
         ...
         #region Инициализировать собственные образы
      ...
      /// <summary>
      /// Given the <paramref name="image"/> Метод для нахождения наиболее похожего изображения
      /// </summary>
      /// <param name="image">Загруженное изображение из файла</param>
      /// <param name="index">Индекс похожего изображения</param>
      ...
      /// <summary>
      /// Попробуйте распознать изображение и вернуть его имя
      /// </summary>
      /// <param name="image">Изображжение которое будет распозноваться</param>
      /// <returns>
      /// Вернет пустую строку если неудалось определить 
      /// Или вернет имя 
      /// </returns>
